...
# Same as node2 except IP address
...
wsrep_node_name=annenode03
wsrep_node_address=172.31.59.71
...
# Launch mysql to bootstrap node3
systemctl start mysql

# Finished
echo -e "\033[9;32m ## FINISHED node3. \033[m" 

# Confirm with...
# mysql> show status like '%wsrep%'

# Move onto MySql Setup